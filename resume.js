...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'web/resume.data';
      var REMOTE_PACKAGE_BASE = 'resume.data';
...
Module['FS_createPath']("/", "fonts", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_web/resume.data');

      };
      Module['addRunDependency']('datafile_web/resume.data');
...
var ___start_em_js = Module['___start_em_js'] = 245792;
var ___stop_em_js = Module['___stop_em_js'] = 246190;
